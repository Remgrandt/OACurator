...
SNIKT.com upload-prefill actions and opening gallery site URLs use the normal browser/network behavior for those sites.
...
- A SNIKT.com upload-prefill action opens a browser workflow.
